...
public class MemoriaRam extends Componente{
    ...
    public Double getConsumoAtual() {
        ...
        consumoAtual = ((consumoAtual / armazenamentoTotal ) * 100);
        BigDecimal bigDecimal = new BigDecimal(consumoAtual);
        BigDecimal arredondado = bigDecimal.setScale(2, RoundingMode.HALF_UP);
        consumoAtual = arredondado.doubleValue();
